...
/**
 * IdentificationsAuditDocuments Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class IdentificationsAuditDocuments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_identifications_audit_documents';
     ...
     * Sets document_type
     *
     * @param string|null $document_type Type of this audit document
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string|null $id ID of this audit document
     *
     * @return $this
     */
