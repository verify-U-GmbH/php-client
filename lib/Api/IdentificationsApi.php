...
class IdentificationsApi
{
     ...
     */
    public function getSchufaById($id)
    {
        list($response) = $this->getSchufaByIdWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation getSchufaByIdWithHttpInfo
     *
     * identifications/schufa/{id}
     *
     * @param  string $id ID of the identification (required)
     ...
     */
    public function getSchufaByIdWithHttpInfo($id)
    {
        $request = $this->getSchufaByIdRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSchufaByIdAsync($id)
    {
        return $this->getSchufaByIdAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSchufaByIdAsyncWithHttpInfo
     *
     * identifications/schufa/{id}
     *
     * @param  string $id ID of the identification (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSchufaByIdAsyncWithHttpInfo($id)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse2001';
        $request = $this->getSchufaByIdRequest($id);
    ...
    /**
     * Create request for operation 'getSchufaById'
     *
     * @param  string $id ID of the identification (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSchufaByIdRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getSchufaById'
            );
        }

        $resourcePath = '/identifications/schufa/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
